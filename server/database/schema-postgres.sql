-- PostgreSQL Schema for StarsTranslations
...
CREATE TABLE IF NOT EXISTS users (
    ...
    patreon_tier VARCHAR(100) DEFAULT 'free',
    access_token TEXT,
    refresh_token TEXT,
...
-- Attachments table (stores metadata, files stored on filesystem/GCS)
...
INSERT INTO tag_types (name, slug, description) VALUES
    ('Platform', 'platform', 'Game engine or platform'),
    ('Genre', 'genre', 'Game genre'),
    ('Fetish', 'fetish', 'Adult content tags')
ON CONFLICT (slug) DO NOTHING;
